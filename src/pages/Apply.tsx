                  ...
                  <div className="space-y-1.5">
                    ...
                    <div className="flex gap-2">
                      <input
                        ...
                        className={cn("flex-1 px-3.5 py-2.5 border-1.5 rounded-sm outline-none transition-colors", contactData.emailVerified ? "bg-green/5 border-green" : "border-grey-200 focus:border-blue bg-white")}
                      />
                    ...
                    {contactData.otpSent && !contactData.emailVerified && (
                      <div className="mt-3 p-4 bg-blue/5 border border-blue/20 rounded-sm">
                        ...
                        <div className="flex gap-2">
                          <input type="text" value={contactData.otpInput} onChange={e => setContactData({...contactData, otpInput: e.target.value.replace(/[^0-9]/g, '').slice(0, 6)})} placeholder="000000" maxLength={6} className="flex-1 px-3.5 py-2.5 border-1.5 border-grey-200 rounded-sm focus:border-blue outline-none text-center font-mono text-lg tracking-[0.3em]" />
